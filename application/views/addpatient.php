                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['name'])){?> <span class="text-danger"><?php echo $error['name']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['age'])){?> <span class="text-danger"><?php echo $error['age']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['gender'])){?> <span class="text-danger"><?php echo $error['gender']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['phone'])){?> <span class="text-danger"><?php echo $error['phone']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['add'])){?> <span class="text-danger"><?php echo $error['add']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['height'])){?> <span class="text-danger"><?php echo $error['height']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['weight'])){?> <span class="text-danger"><?php echo $error['weight']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['blood_group'])){?> <span class="text-danger"><?php echo $error['blood_group']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['blood_pressure'])){?> <span class="text-danger"><?php echo $error['blood_pressure']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['pulse'])){?> <span class="text-danger"><?php echo $error['pulse']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['respiration'])){?> <span class="text-danger"><?php echo $error['respiration']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['allergy'])){?> <span class="text-danger"><?php echo $error['allergy']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($error['diet'])){?> <span class="text-danger"><?php echo $error['diet']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">

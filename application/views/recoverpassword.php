            ...
            <div class="card">
                <div class="card-block">
                    <h3 class="text-center m-0">
                        <img class="logo logo-admin" src="<?php echo base_url(); ?>assets/images/<?php echo $data[0]['logo']; ?>" height="30" alt="logo">
                    </h3>
                        ...
                        <form class="form-horizontal m-t-30">
                            ...
                            <div class="form-group row m-t-20">
                                <div class="col-12 text-right">
                                    <button class="btn btn-primary w-md waves-effect waves-light disabled" type="submit" disabled id="reset">Reset</button>
                                </div>
                            </div>
                        </form>
                    </div>

                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php if(!empty($error['patient_id'])){?> <span class="text-danger"><?php echo $error['patient_id']; ?></span> <?php } ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php if(!empty($error['symptoms'])){?> <span class="text-danger"><?php echo $error['symptoms']; ?></span> <?php } ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php if(!empty($error['diagnosis'])){?> <span class="text-danger"><?php echo $error['diagnosis']; ?></span> <?php } ?>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-md-5">
                                                                        ...
                                                                        <?php if(!empty($error['medicine_name'])){?> <span class="text-danger"><?php echo $error['medicine_name']; ?></span> <?php } ?>

                                                                    </div>
                                                                    <div class="col-md-5">
                                                                        <input type="text" class="form-control" placeholder="Notes" name="medicine_note[]" required="">
                                                                        <?php if(!empty($error['medicine_note'])){?> <span class="text-danger"><?php echo $error['medicine_note']; ?></span> <?php } ?>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-md-5">
                                                                        ...
                                                                        <?php if(!empty($error['test_name'])){?> <span class="text-danger"><?php echo $error['test_name']; ?></span> <?php } ?>

                                                                    </div>
                                                                    <div class="col-md-5">
                                                                        <input type="text" class="form-control" placeholder="Notes" name="test_note[]" required="">
                                                                        <?php if(!empty($error['test_note'])){?> <span class="text-danger"><?php echo $error['test_note']; ?></span> <?php } ?>

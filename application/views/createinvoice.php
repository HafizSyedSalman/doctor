                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php if(!empty($error['payment_mode'])){?> <span class="text-danger"><?php echo $error['payment_mode']; ?></span> <?php } ?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php if(!empty($error['payment_status'])){?> <span class="text-danger"><?php echo $error['payment_status']; ?></span> <?php } ?>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-md-5">
                                                                        ...
                                                                        <?php if(!empty($error['invoice_title'])){?> <span class="text-danger"><?php echo $error['invoice_title']; ?></span> <?php } ?>
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        ...
                                                                        <?php if(!empty($error['invoice_amount'])){?> <span class="text-danger"><?php echo $error['invoice_amount']; ?></span> <?php } ?>

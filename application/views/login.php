    ...
    <body class="fixed-left">
        ...
        <div class="wrapper-page">
            ...
            <div class="m-t-40 text-center">
                <p class="text-white">© <?php $data = $this->user_mo->get_user(); echo date('Y').' '.$data[0]['title']; ?> . Crafted with <i class="mdi mdi-heart text-danger"></i> by <a href="https://mavericktechnolo.com/">Maverick Technology<a></p>
            </div>
        </div>

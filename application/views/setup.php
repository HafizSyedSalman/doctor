            ...
            <div class="card">
                <div class="card-block">
                    ...
                    <div class="p-3">
                        ...
                        <?php $data = $this->session->flashdata('image');if(!empty($data)){echo $data['error'];}?>
                        </div>
                        	...
                        	<div class="row">
                        		<div class="col-md-6">
                        			<div class="form-group">
                                        ...
                                        <?php if(!empty($error['dname'])){?> <span class="text-danger"><?php echo $error['dname']; ?></span> <?php } ?>
                                    </div>
                        		</div>
                        		<div class="col-md-6">
                        			<div class="form-group">
                                        ...
                                        <?php if(!empty($error['email'])){?> <span class="text-danger"><?php echo $error['email']; ?></span> <?php } ?>
		                            </div>
                        		</div>
                        	</div>
                        	...
                        	<div class="row">
                        		...
                        		<div class="col-md-6">
                        			<div class="form-group">
                                        ...
                                        <?php if(!empty($error['username'])){?> <span class="text-danger"><?php echo $error['username']; ?></span> <?php } ?>
		                            </div>
                        		</div>
                        	</div>
                        	...
                        	<div class="row">
                        		<div class="col-md-6">
                        			<div class="form-group">
                                        ...
                                        <?php if(!empty($error['password'])){?> <span class="text-danger"><?php echo $error['password']; ?></span> <?php } ?>
		                            </div>
                        		</div>
                        		<div class="col-md-6">
                        			<div class="form-group">
                                        ...
                                        <?php if(!empty($error['cpassword'])){?> <span class="text-danger"><?php echo $error['cpassword']; ?></span> <?php } ?>
		                            </div>
                        		</div>
                        	</div>
                        	...
                        	<div class="row">
                        		<div class="col-md-12">
                        			<div class="form-group">
                                        ...
                                        <?php if(!empty($error['title'])){?> <span class="text-danger"><?php echo $error['title']; ?></span> <?php } ?>
		                            </div>
                        		</div>
                        	</div>
